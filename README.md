...
The complete component list, with quantities specified, can be found in the following [document](http://jovantormesvaquerano/PeRo-Lab-Pupillometry-Wheel/1-Pupillometry-Components-Table).
