...
The complete component list, with quantities specified, can be found in the following [document](PeRo-Lab-Pupillometry-Wheel/(a) Pupillometry Components Table.pdf).
